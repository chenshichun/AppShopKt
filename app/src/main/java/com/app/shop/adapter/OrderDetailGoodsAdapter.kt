...
import com.app.shop.databinding.ItemOrderDetailGoodsBinding
 ...
 * 描述：
 */
class OrderDetailGoodsAdapter(private val context: Context, val mData: List<OrderItem>?) :
    RecyclerView.Adapter<OrderDetailGoodsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemOrderDetailGoodsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ViewHolder(binding: ItemOrderDetailGoodsBinding) :
